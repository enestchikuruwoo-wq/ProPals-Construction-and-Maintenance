        ...
        <div className="flex flex-col lg:flex-row gap-8 items-stretch">
          ...
          >
            ...
            <div className="relative z-10">
              ...
              <h1 className="text-5xl md:text-7xl lg:text-8xl font-display font-extrabold leading-[1.05] mb-8 tracking-tight">
                Precision <br />
                <span className="text-accent-blue font-display font-extrabold">Building.</span><br />
                <span className="text-white font-display font-extrabold">Professional Results.</span>
              </h1>
